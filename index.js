...
function changeTheme() {
  if(isDark) {
    ...
    searchField.style.backgroundColor = 'var(--main-color)';
    authorLink.style.backgroundColor = 'var(--main-color)';
    authorName.style.color = 'var(--text-color)';
    ...
    searchField.style.backgroundColor = 'var(--bg-grey)';
    authorLink.style.backgroundColor = 'var(--bg-grey)';
    authorName.style.color = 'var(--main-color)';
