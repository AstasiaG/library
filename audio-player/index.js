...
function playAudio() {
  ...
  playPause.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" viewBox="0 0 70 70" fill="none"><path d="M29.1667 26.25V43.75M40.8333 26.25V43.75M61.25 35C61.25 38.4472 60.571 41.8606 59.2518 45.0454C57.9327 48.2302 55.9991 51.124 53.5616 53.5616C51.124 55.9991 48.2302 57.9327 45.0454 59.2518C41.8606 60.571 38.4472 61.25 35 61.25C31.5528 61.25 28.1394 60.571 24.9546 59.2518C21.7698 57.9327 18.876 55.9991 16.4384 53.5616C14.0009 51.124 12.0673 48.2302 10.7482 45.0454C9.42898 41.8606 8.75 38.4472 8.75 35C8.75 28.0381 11.5156 21.3613 16.4384 16.4384C21.3613 11.5156 28.0381 8.75 35 8.75C41.9619 8.75 48.6387 11.5156 53.5616 16.4384C58.4844 21.3613 61.25 28.0381 61.25 35Z" stroke="#6588E1" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/></svg>';
...
console.log('Оценка 60/60\n\n 1.Вёрстка +10\n 2. Кнопка Play/Pause +10\n 3. "Вперёд" и "Назад" переключают трек, пролистываются по кругу +10\n 4. При смене аудиотрека меняется изображение - обложка аудиотрека +10\n 5. Прогресс-бар отображает прогресс, можно изменить вручную +10\n 6. Отображается продолжительность аудиотрека +10\n 7. Регулятор громкости и зацикливание трека')